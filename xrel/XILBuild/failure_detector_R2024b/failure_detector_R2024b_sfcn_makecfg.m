function failure_detector_R2024b_sfcn_makecfg(BuildInfo)
%FAILURE_DETECTOR_R2024B_SFCN_MAKECFG adds include and source directories to the BuildInfo object.

%    Simulink version    : 24.2 (R2024b) 21-Jun-2024
%    MATLAB file generated on : 10-Mar-2025 18:58:48
...
info(1).SFunctionName = 'failure_detector_R2024b_sfcn';
info(1).IncPaths = {'D:\MBD_challenge', 'D:\MBD_challenge\failure_detector_ert_rtw'};
info(1).SrcPaths = {'D:\MBD_challenge', 'D:\MBD_challenge\failure_detector_ert_rtw'};
info(1).SourceFiles = {'failure_detector.c'};
info(1).Language = 'C';
