...
## Generated on : Mon Mar 10 18:59:13 2025
## Final product: ./failure_detector_R2024b.exe
...
MODELREF_LINK_RSPFILE     = failure_detector_R2024b_ref.rsp
...
PRODUCT = ./failure_detector_R2024b.exe
...
MODELREF_LIBS = ../failure_detector_R2024b.obj ../failure_detector.obj

LIBS = $(START_DIR)/failure_detector_R2024b_ert_rtw/coderassumptions/lib/failure_detector_R2024b_ca.lib
...
xil_interface.obj : $(START_DIR)/failure_detector_R2024b_ert_rtw/sil/xil_interface.c
	$(CC) $(CFLAGS) -o "$@" "$<"


sil_main.obj : $(START_DIR)/failure_detector_R2024b_ert_rtw/sil/sil_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
