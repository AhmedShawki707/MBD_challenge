...
#include "failure_detector_R2024b.h"   /* Model header file */
...
void rt_OneStep(void)
{
  ...
  /* Check for overrun */
  if (OverrunFlag) {
    rtmSetErrorStatus(xrelfailure_detector_R2024b_M, "Overrun");
    return;
  }
...
int_T main(int_T argc, const char *argv[])
{
  ...
  /* Initialize model */
  failure_detector_R2024b_initialize();
  ...
  fflush((NULL));
  while (rtmGetErrorStatus(xrelfailure_detector_R2024b_M) == (NULL)) {
    /*  Perform application tasks here */
  }

  /* Terminate model */
  failure_detector_R2024b_terminate();
  return 0;
}
