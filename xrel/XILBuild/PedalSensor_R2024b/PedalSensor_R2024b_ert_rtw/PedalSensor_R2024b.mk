...
## Generated on : Mon Mar 10 18:54:11 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/PedalSensor_R2024b.exe
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/PedalSensor_R2024b.exe
...
SRCS = $(START_DIR)/PedalSensor_R2024b_ert_rtw/PedalSensor_R2024b.c PedalSensor.c

MAIN_SRC = $(START_DIR)/PedalSensor_R2024b_ert_rtw/ert_main.c
...
OBJS = PedalSensor_R2024b.obj PedalSensor.obj
...
%.obj : $(START_DIR)/PedalSensor_R2024b_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/PedalSensor_R2024b_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/PedalSensor_R2024b_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/PedalSensor_R2024b_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/PedalSensor_R2024b_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.obj : D:/MBD_challenge/PedalSensor_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : D:/MBD_challenge/PedalSensor_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : D:/MBD_challenge/PedalSensor_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : D:/MBD_challenge/PedalSensor_ert_rtw/%.cp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.obj : D:/MBD_challenge/PedalSensor_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
PedalSensor_R2024b.obj : $(START_DIR)/PedalSensor_R2024b_ert_rtw/PedalSensor_R2024b.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.obj : $(START_DIR)/PedalSensor_R2024b_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
