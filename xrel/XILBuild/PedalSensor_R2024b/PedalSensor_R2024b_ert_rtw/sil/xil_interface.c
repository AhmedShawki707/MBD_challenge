 ...
 *
 * SIL generated interface for code: "PedalSensor_R2024b"
 *
 */

#include "PedalSensor_R2024b.h"
#include "PedalSensor_R2024b_private.h"
      ...
      if (!initComplete) {
...

        {
          void * dataAddress = (void *)
            &(xrelPedalSensor_R2024b_U.pedal_position);
   ...
   case XIL_INITIALIZE_COMMAND:
    {
      ...
      if (!initComplete) {
        ...
        {
          void * dataAddress = (void *)
            &(xrelPedalSensor_R2024b_Y.sensor1_reading);
        ...
        {
          void * dataAddress = (void *)
            &(xrelPedalSensor_R2024b_Y.sensor2_reading);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(real_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
        ...
        {
          void * dataAddress = (void *)
            &(xrelPedalSensor_R2024b_Y.sensor1_failure);
        ...
        {
          void * dataAddress = (void *)
            &(xrelPedalSensor_R2024b_Y.sensor2_failure);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
        ...
        {
          void * dataAddress = (void *)
            &(xrelPedalSensor_R2024b_Y.coherency_failure);
          xil_fcnid0_init_y[tableIdx].memUnitLength = 1 * sizeof(boolean_T);
          xil_fcnid0_init_y[tableIdx++].address = (MemUnit_T *) dataAddress;
        }
