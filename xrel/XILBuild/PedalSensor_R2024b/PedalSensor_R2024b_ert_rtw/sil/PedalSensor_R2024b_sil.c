/*
 * PedalSensor_R2024b_sil.c
 *
 * Automatically generated s-function with I/O interface for:
 * Component: PedalSensor_R2024b
 * Component Simulink Path: PedalSensor_R2024b
 * Simulation Mode: SIL
 *
 */

#define S_FUNCTION_NAME                PedalSensor_R2024b_sil
...
static boolean_T startAndSetupApplication(SimStruct *S)
{
...

  {
    ...
    {
      mxArray * codeGenComponent = mxCreateString("PedalSensor_R2024b");
      mxArray *rhs[3];
      const char * simulinkBlockPath = ssGetPath(S);
      rhs[ 0 ] = mxCreateString(
        "@coder.connectivity.SimulinkInterface.getSILPILInterface");
