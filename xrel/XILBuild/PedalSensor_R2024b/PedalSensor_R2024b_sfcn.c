/**
 * PedalSensor_R2024b_sfcn.c
 *
 *    ABSTRACT:
 *      The purpose of this sfunction is to call a simple legacy
 *      function during simulation:
 *
 *         PedalSensor_step(void)
 *
 *    Simulink version           : 24.2 (R2024b) 21-Jun-2024
 *    C source code generated on : 10-Mar-2025 18:53:23
 *
...
/**
     ...
     def.SFunctionName = 'PedalSensor_R2024b_sfcn';
     def.OutputFcnSpec = 'PedalSensor_step(void)';
     def.StartFcnSpec = 'PedalSensor_initialize(void)';
     def.TerminateFcnSpec = 'PedalSensor_terminate(void)';
     def.GlobalVarSpec = {'double u1 : PedalSensor_U.pedal_position', 'double y1 : PedalSensor_Y.sensor1_reading', 'double y2 : PedalSensor_Y.sensor2_reading', 'boolean y3 : PedalSensor_Y.sensor1_failure', 'boolean y4 : PedalSensor_Y.sensor2_failure', 'boolean y5 : PedalSensor_Y.coherency_failure'};
     def.HeaderFiles = {'PedalSensor.h'};
     def.SourceFiles = {'PedalSensor.c'};
     def.IncPaths = {'D:\MBD_challenge', 'D:\MBD_challenge\PedalSensor_ert_rtw'};
     def.SrcPaths = {'D:\MBD_challenge', 'D:\MBD_challenge\PedalSensor_ert_rtw'};
     def.SampleTime = 0.2;
...
#define S_FUNCTION_NAME  PedalSensor_R2024b_sfcn
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "PedalSensor_initialize", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "PedalSensor_step", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

        /* Register reserved identifier for  */
        ssRegMdlInfo(S, "PedalSensor_terminate", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
